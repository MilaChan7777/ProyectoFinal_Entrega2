import Home, { Attribute } from './components/menu/Home';
import Search, { Attribute1 } from './components/menu/search';
import Post, { Attribute2 } from './components/menu/post';
import Profile, { Attribute3 } from './components/menu/profile';

import usersData, { Attribute4 } from './components/userPosts/userPosts';
import Save, { Attribute5 } from './components/buttonPosts/save';
import Star, { Attribute6 } from './components/buttonPosts/star';
import Comment, { Attribute7 } from './components/buttonPosts/comment';
